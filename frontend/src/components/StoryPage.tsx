...
export default function StoryPage({
  ...
  return (
    <div className="min-h-screen bg-[#0D0D1A] text-white">
      ...
      {/* Footer */}
      <footer className="py-8 text-center text-white/15 text-xs px-6 border-t border-white/5 flex flex-col items-center gap-2">
        <p>Posit Data Science Hangout · unofficial fan project · not affiliated with Posit PBC</p>
        <a
